...
print ('Os 4 últimos colocados são {}.' .format(table[16:21]))
print ('A ordem alfabética da tabela do Brasileirão é: {}.' .format(sorted(table)))
print ('O Mirassol está em {}º lugar na tabela do Brasileirão.' .format(table.index('Mirassol') + 1))